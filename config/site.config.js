...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ziyuan@775500.xyz',
  ...
  protectedRoutes: ['/嘿嘿嘿', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:suibian@ccav.faith',
